...
//
// [解题方法]
// 由题意可知，Vladimir 在乘坐火车从一个城市到另一个城市时可以有多种路线，其中出发时间不在 18：00
// 之后且到达时间不在 06：00 之前的都可以不予考虑，然后对这些满足要求的路线用 DAG 建模，问题即求
// 图中两点的最短路线。其中需要注意的是，由于需要将携带血量最小化，故需要考虑从起始城市到终点城市的
// 所有路线，因为有可能从 A 到 B 的车是 18:00 出发，20:00 到达 B，然后再从 B 到 C，有出发时间
// 为 21:00，24:00 到达 C 的火车路线，这样若从 A 到 C 就不需在车站停留，从而不需喝 1 升的血，
// 所以虽然总路线不是最短的，但是携带血量可以是最少的，故需要遍历可能的通路来获取最少使用血量，这个
// 可以通过使用宽度优先遍历的思想来解决。
