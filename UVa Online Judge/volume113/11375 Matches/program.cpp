...
int main(int argc, char *argv[])
{
    ...
    string d[2010], r[2010];

    d[2] = "1", d[3] = "1", d[4] = "2", d[5] = "5", d[6] = "7", d[7] = "12";
    r[1] = "0", r[2] = "1", r[3] = "2", r[4] = "4", r[5] = "9", r[6] = "16", r[7] = "28";

    for (int i = 8; i <= 2000; i++)
    {
        d[i] = add(add(add(d[i - 2], d[i - 3]), add(d[i - 4], multiply("3", add(d[i - 5], d[i - 6])))), d[i - 7]);
        r[i] = add(r[i - 1], subtract(d[i], d[i - 6]));
    }

    int n;
    while (cin >> n) cout << r[n] << '\n';
