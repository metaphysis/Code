...
// 分治法求最近点对距离。
int closestDistance(int *P, int Pn, int *X, int Xn, int *Y, int Yn)
{
...
int getClosestDistance(int number)
{
...
int main(int ac, char *av[])
{
    ...
    while (cin >> number)
    {
        ...
        int minDist = getClosestDistance(number);
