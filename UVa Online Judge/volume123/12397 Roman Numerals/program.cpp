...
int main(int argc, char *argv[])
{
    ...
    while (cin >> arab)
    {
        string roman = arab2Roman(arab);
        
        int matches = 0;
        for (int i = 0; i < roman.length(); i++)
        {
            if (roman[i] == 'I') matches += 1;
            else if (roman[i] == 'V') matches += 2;
            else if (roman[i] == 'X') matches += 2;
            else if (roman[i] == 'L') matches += 2;
            else if (roman[i] == 'C') matches += 2;
            else if (roman[i] == 'D') matches += 3;
            else if (roman[i] == 'M') matches += 4;
        }
